defmodule Mix.Tasks.Atomvm.Esp32.IdfMonitor do
  ...
  `--no-reset` leaves it running instead. The monitor runs until it is quit
  with Ctrl+], or for `--timeout` seconds.
  ...
  @usage "mix atomvm.esp32.idf_monitor [--port PORT] [--baud RATE] [--no-reset] [--timeout SECONDS] [-- ESP-IDF-MONITOR-OPTIONS]"
